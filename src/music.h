...
//either wrap into namespace or use inline
inline constexpr int buzzer{7}; //constexpr - compile-time constant
inline constexpr int buttonPin{2};

//menu items
inline const char music_menu[][16] = {
  "imperial march",
  "hedwig's theme",
  "prince Igor",
  "Game of Thrones",
...
playM(2){
  display song title:
  tracklist[2];
  play song in a for loop (i):
  melody[2][i];
}
*/
/* use music_menu instead
inline const char tracklist[][16] = {
  "imperial march",
  "hedwig's theme",
  "another song"
};
*/
inline const int melody[][276] = {
